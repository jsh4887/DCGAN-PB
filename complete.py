...
parser.add_argument('--imgSize', type=int, default=32) # 32, 64
parser.add_argument('--lam', type=float, default=0.1)

parser.add_argument('--checkpointDir', type=str, default='./checkpoint_2002_2019_32_32')
...
with tf.Session(config=config) as sess:
    dcgan = DCGAN(sess, image_size=args.imgSize,
                  batch_size=min(32, len(args.imgs)),
